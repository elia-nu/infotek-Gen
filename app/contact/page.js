                ...
                <div className="row g-4 align-items-center">
                      ...
                      <div className="contact-info-area-2">
                        <div className="contact-info-items mb-4">
                          ...
                          <div className="content">
                            <p>Call Us 7/24</p>
                            <h3>
                              <Link href="/tel:+12063535373">
                                +1 (206) 353-5373
                              </Link>
                            </h3>
                            <h3>
                              <Link href="/tel:+15404971763">
                                +1 (540) 497-1763
                              </Link>
                            </h3>
                          </div>
                        ...
                        <div className="contact-info-items mb-4">
                          ...
                          <div className="content">
                            <p>Email us at</p>
                            <h3>
                              <Link href="/mailto:info@genshifter.com">
                                {contact[0]?.email}
                              </Link>
                            </h3>
                          </div>
                        ...
                        <div className="contact-info-items mb-4">
                          ...
                          <div className="content">
                            ...
                            <h3>
                              7740 Delridge Way SW Apt A, Seattle, WA,
                              98106-1738, United States
                            </h3>
                          </div>
                        </div>
                        <div className="contact-info-items border-none">
                          ...
                          <div className="content">
                            <img
                              ...
                              style={{ width: "60px", marginRight: "8px" }}
                            />
                            <p>Ethiopia Location</p>
                            <h3>{contact[0]?.address}</h3>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="contact-content">
                      ...
                      <p>
                        "Ready to get started with GenShifter Technologies.?
                        Empower your business with our cutting-edge technology
                        solutions, expert software development, and tailored IT
                        services. Let us help you innovate and achieve your
          ...
          <div className="map-section">
            <div className="map-items">
              <div className="googpemap">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4895.014511527463!2d38.76563057589901!3d9.005178091055207!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b85fd6d2d8d7f%3A0xfee7af84ac652672!2sTigi%20Building!5e1!3m2!1sen!2set!4v1736870652797!5m2!1sen!2set"
                  style={{ border: 0 }}
                  allowFullScreen
                  loading="lazy"
                />
