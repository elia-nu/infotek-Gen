              ...
              <div className="col-lg-6 mt-4 mt-lg-0">
                <div className="about-content">
                  <div className="section-title">
                    <span className="wow fadeInUp" style={{ color: "orange" }}>
                      {aboutData.title}
                    </span>
                  ...
                  <div className="about-author">
                    ...
                    <div
                      className="author-icon wow fadeInUp"
                      data-wow-delay=".9s"
                    >
                      <div className="icon">
