    ...
    <>
      <footer className="footer-section">
        <div className="footer-widgets-wrapper footer-bg">
          ...
          <div className="container">
            <div className="row">
              ...
              >
                <div className="single-footer-widget">
                  <div className="widget-head">
                    <Link href="/">
                      <img
                        src="/assets/img/header/logo_f.png"
                        style={{ width: "150px" }}
                        alt="logo-img"
                      />
                    </Link>
                  ...
                  <div className="footer-content">
                    ...
                    <div className="social-icon d-flex align-items-center">
                      ...
                      <Link href={`${contact[0]?.telegram}`} target="_blank">
                        <i className="fab fa-telegram" />
                      </Link>
                      <Link href={`${contact[0]?.linkedin}`} target="_blank">
              ...
              <div
                className="col-xl-3 col-lg-3 col-md-5 ps-lg-4 wow fadeInUp"
                data-wow-delay=".5s"
              >
                <div className="single-footer-widget style-margin">
                  ...
                  <ul className="list-area">
                    {service.map((service, index) => (
                      <li key={index}>
                        <Link
                          href={`/service-details?title=${encodeURIComponent(
                            service._id
                          )}`}
                        >
                          <i className="fa-solid fa-chevron-right" />
              ...
              <div
                className="col-xl-3 col-lg-4 col-md-6 ps-xl-6 wow fadeInUp"
                data-wow-delay=".9s"
              >
                <div className="single-footer-widget">
                  <div className="widget-head">
                  ...
                  <div className="footer-content">
                    <ul className="contact-info">
                      ...
                      <li>
                        ...
                        <Link href={`tel:${contact[0]?.phone1}`}>
                          {contact[0]?.phone1}
                        </Link>
                      </li>
                      <li>
                        <i className="fa-solid fa-phone-volume" />
                        <Link href={`tel:${contact[0]?.phone2}`}>
                          {contact[0]?.phone2}
                        </Link>
                      </li>
                      <li>
                        <i className="fa-solid fa-phone-volume" />
                        <Link href={`tel:${contact[0]?.phone3}`}>
                          {contact[0]?.phone3}
                        </Link>
                      </li>
                    </ul>
          ...
          <div className="container">
            <div className="footer-wrapper d-flex align-items-center justify-content-between">
              <p className="wow fadeInLeft color-2" data-wow-delay=".3s">
                <span style={{ fontSize: "30px" }}>©</span> All Copyright{" "}
                {new Date().getFullYear()} by{" "}
                <Link href="/">GenShifter Technologies.</Link>
              </p>
              <ul className="footer-menu wow fadeInRight" data-wow-delay=".5s">
                <li>
                  <a onClick={toggleDialog}>Terms &amp; Condition</a>
                </li>
                <li>
                  <a
                    onClick={() =>
          ...
          >
            ...
            <ol style={{ paddingLeft: "20px", color: "#444" }}>
              <li>
                ...
                <p>
                  Welcome to GenShifter Technologies. ("GenShifter," "we," "us,"
                  or "our"). This Privacy Policy explains how we collect, use,
                  disclose, and protect your personal information when you
                  access or use our website, products, or services. By using our
              ...
              <li>
                ...
                <ul style={{ paddingLeft: "20px" }}>
                  <li>
                    ...
                    phone number, and payment details that you provide when
                    engaging with our services.
                  </li>
                  <li>
                    <strong>Usage Data:</strong> Information about your
                    interactions with our website or services, such as IP
                  ...
                  <li>
                    ...
                    on our website, track user activity, and analyze trends.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul style={{ paddingLeft: "20px" }}>
                  <li>
                    To Provide and Improve Services: To deliver and enhance the
                    services you request and manage your account.
                  </li>
                  <li>
                    To Communicate with You: To respond to inquiries, send
                    updates, and provide important notices related to our
                    services.
                  </li>
                  <li>
                    For Billing and Payments: To process transactions and manage
                    billing.
                  </li>
                  <li>
                    To Analyze and Improve: To analyze usage patterns, track
                    performance, and improve our website and services.
                  </li>
                  <li>
                    For Marketing: With your consent, to send promotional
              ...
              <li>
                ...
                <ul style={{ paddingLeft: "20px" }}>
                  <li>
                    Service Providers: Third-party vendors who perform services
                    on our behalf, such as payment processing, data analysis,
                    and customer support.
                  </li>
                  <li>
                    Legal Requirements: To comply with legal obligations,
                    enforce our Terms, or protect the rights, property, or
                    safety of GenShifter, our clients, or others.
                  </li>
                  <li>
                    Business Transfers: In connection with a merger,
                    acquisition, or sale of assets, where your information may
              ...
              <li>
                ...
                <ul style={{ paddingLeft: "20px" }}>
                  <li>
                    Access: The right to request access to the personal
                    information we hold about you.
                  </li>
                  <li>
                    Correction: The right to request correction of inaccurate or
                  ...
                  <li>
                    Opt-Out: The right to opt-out of receiving marketing
                    communications.
                  </li>
                </ul>
                <p>
              ...
              <li>
                ...
                <p>
                  GenShifter Technologies.
                  <br />
                  Email:{" "}
                  <a
                    href="mailto:info@genshifter.com"
                    style={{ color: "#007bff" }}
                  >
                    info@genshifter.com
                  </a>
                  <br />
                  Phone:{" "}
                  <a href="tel:+251910813571" style={{ color: "#007bff" }}>
                    +251910813571
                  </a>
                  <br />
                ...
                <p>
                  ...
                  understood, and agree to this Privacy Policy. Thank you for
                  choosing GenShifter Technologies..
                </p>
              </li>
            </ol>
        ...
        {isOpen && (
          ...
          >
            <div
              className="bg-white w-75 rounded shadow p-4 overflow-auto"
              style={{ maxHeight: "90vh" }}
            >
              <h2 className="h4 font-weight-bold text-dark">
                Terms and Conditions..
              </h2>
              <p className="small text-muted">Last Updated: September 2024</p>
              <p className="text-dark">
                These Terms and Conditions ("Terms") govern your access to and
                use of GenShifter Technologies. ("GenShifter," "we," "us," or
                "our"). By accessing or using our website, products, or
                services, you agree to be bound by these Terms. If you do not
                agree with these Terms, please do not use our services. These
                Terms affect your legal rights and obligations, so please read
                them carefully.
              </p>
              ...
              <p className="text-dark">
                ...
                by these Terms, which form a legally binding agreement between
                you and GenShifter. You agree to comply with all applicable
                laws, rules, and regulations when using our services.
              </p>

              <h3 className="h5 font-weight-bold text-dark">2. Definitions</h3>
              <ul className="list-unstyled text-dark">
                <li>
                  <strong>“Services”:</strong> The full range of software
                  development, IT consulting, maintenance, and related
                  technology solutions provided by GenShifter.
                </li>
                <li>
                ...
                <li>
                  <strong>“Content”:</strong> Any data, information, software,
                  or material displayed or shared through our platform or
                  services.
                </li>
              </ul>
              ...
              <p className="text-dark">
                GenShifter reserves the right to modify, amend, or update these
                Terms at any time. Changes will take effect immediately upon
                posting the updated Terms on our website. We recommend reviewing
                these Terms regularly to stay informed of any updates. Your
              ...
              <p className="text-dark">
                GenShifter offers custom software development, IT consultancy,
                mobile app development, and related technology services. The
                scope of services provided to each client will be defined in a
                mutually agreed-upon service agreement, contract, or proposal.
              </p>
              ...
              <p className="text-dark">
                GenShifter is committed to providing high-quality services. We
                make every reasonable effort to meet agreed-upon deadlines and
                deliver services as outlined in individual contracts. However,
                delivery timelines may be affected by factors beyond our
                control, including third-party delays, unforeseen technical
                challenges, or force majeure events.
              </p>
              ...
              <p className="text-dark">
                GenShifter reserves the right to modify or discontinue any part
                of our services at any time without prior notice. Clients will
                be notified if such changes significantly affect ongoing
                projects.
              </p>
              ...
              <p className="text-dark">
                ...
                resources may result in project delays, for which GenShifter
              ...
              <p className="text-dark">
                In case of delayed payments, GenShifter reserves the right to
                charge a late fee or interest at the rate specified in the
                service contract or invoice. Failure to pay outstanding balances
                may lead to suspension or termination of services.
              </p>

              <h4 className="h6 font-weight-bold text-dark">6.3 Taxes</h4>
              <p className="text-dark">
                All fees charged by GenShifter will include any applicable
                sales, use, VAT, or other taxes. GenShifter is responsible for
                any applicable taxes associated with the purchase of services
              ...
              <p className="text-dark">
                For services provided within Ethiopia, GenShifter will comply
                with applicable Ethiopian tax laws, including Value Added Tax
                (VAT). All fees and payments will be subject to Ethiopian tax
                ...
                writing. GenShifter reserves the right to amend invoices and
                charge the client for any applicable taxes that were not
                initially included due to oversight or later-imposed legal
                obligations.
              </p>
              <h3 className="h5 font-weight-bold text-dark">
              ...
              <p className="text-dark">
                <strong>7.1 Confidential Information:</strong> GenShifter agrees
                to keep all client data, proprietary information, and sensitive
                business details confidential and will not disclose them to
              ...
              <p className="text-dark">
                ...
                applications, and technology created or provided by GenShifter
                as part of our services are the intellectual property of
                GenShifter unless expressly transferred to the client through a
              ...
              <p className="text-dark">
                ...
                software or applications developed by GenShifter, subject to the
                terms specified in the service contract.
              </p>
              ...
              <p className="text-dark">
                GenShifter will provide warranties or guarantees as specified in
                the service agreement with the client or involved parties. These
              ...
              <p className="text-dark">
                GenShifter shall not be held liable for any indirect,
                incidental, special, or consequential damages, including loss of
                revenue, profits, data, or business opportunities, arising out
                of or in connection with the use of our services.
              </p>
              <p className="text-dark">
                GenShifter's maximum liability shall be limited to the fees paid
              ...
              <p className="text-dark">
                You agree to indemnify and hold harmless GenShifter, its
                affiliates, officers, directors, employees, and agents from any
                claims, liabilities, damages, or expenses arising out of your
                use of our services, breach of these Terms, or violation of any
                third-party rights.
              </p>
              ...
              <p className="text-dark">
                GenShifter reserves the right to suspend or terminate access to
                our services at any time, with or without cause, including for
              ...
              <p className="text-dark">
                GenShifter will not be liable for any failure or delay in
                performing our obligations due to unforeseen events beyond our
              ...
              <p className="text-dark">
                ...
                action related to these Terms shall be brought exclusively in
              ...
              <p className="text-dark">
                These Terms, along with any additional agreements or contracts
                you enter into with GenShifter, constitute the entire agreement
                between you and GenShifter and supersede any prior agreements.
              </p>
              ...
              <button onClick={toggleDialog} className="btn btn-danger mt-3">
                Close
              </button>
            </div>
          </div>
...
const data = {
  company: {
    ...
    description:
      "GenShifter Technologies offers a comprehensive range of IT services to drive business growth through innovative technology and expertise. We specialize in software development, managed services, infrastructure management, system integration, training, and cybersecurity.",
    services: [
      {
        title: "Software Development",
        description:
          "At GenShifter Technologies, we offer a comprehensive range of software development solutions tailored to meet your unique business needs and drive growth through innovative technology and industry expertise. Our services include:",
        subservices: [
          {
      ...
      },
      {
        ...
        description:
          "At GenShifter Technologies, our Cybersecurity Services are designed to provide robust protection against digital threats and ensure the safety of your critical data and systems. Our comprehensive offerings include Security Audits and Assessments, Threat Detection and Response, Vulnerability Management, and Data Encryption and Protection. We implement advanced strategies to fortify your digital environment, proactively identify risks, and maintain the highest level of security.",
        subservices: [
          {
